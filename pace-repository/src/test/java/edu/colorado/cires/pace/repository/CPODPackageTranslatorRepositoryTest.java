...
public class CPODPackageTranslatorRepositoryTest extends TranslatorRepositoryTest {
  ...
  protected void assertObjectsEqual(Translator expected, Translator actual, boolean checkUUID) {
    ...
    assertEquals(((DefaultTimeTranslator) expectedCPODTranslator.getDeploymentTime()).getTime(), ((DefaultTimeTranslator) actualCPODTranslator.getDeploymentTime()).getTime());
    assertEquals(((DefaultTimeTranslator) expectedCPODTranslator.getRecoveryTime()).getTime(), ((DefaultTimeTranslator) actualCPODTranslator.getRecoveryTime()).getTime());
