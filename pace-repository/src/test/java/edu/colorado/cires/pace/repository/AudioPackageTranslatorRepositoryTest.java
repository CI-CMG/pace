...
public class AudioPackageTranslatorRepositoryTest extends TranslatorRepositoryTest {
  ...
  protected Translator copyWithUpdatedUniqueField(Translator object, String uniqueField) {
    return ((AudioPackageTranslator) object).toBuilder()
        .name(uniqueField)
        .build();
  }
  ...
  protected void assertObjectsEqual(Translator expected, Translator actual, boolean checkUUID) {
    ...
    assertEquals(((DefaultTimeTranslator) expectedAudioTranslator.getDeploymentTimeTranslator()).getTime(), ((DefaultTimeTranslator) actualAudioTranslator.getDeploymentTimeTranslator()).getTime());
    assertEquals(((DefaultTimeTranslator) expectedAudioTranslator.getRecoveryTimeTranslator()).getTime(), ((DefaultTimeTranslator) actualAudioTranslator.getRecoveryTimeTranslator()).getTime());
    ...
    QualityControlDetailTranslator expectedQCTranslator = expectedAudioTranslator.getQualityControlDetailTranslator();
    QualityControlDetailTranslator actualQCTranslator = actualAudioTranslator.getQualityControlDetailTranslator();
