...
public class AudioPackageTranslatorRepositoryTest extends TranslatorRepositoryTest {
  ...
  protected void assertObjectsEqual(Translator expected, Translator actual, boolean checkUUID) {
    ...
    assertEquals(expectedAudioTranslator.getDeploymentTime(), actualAudioTranslator.getDeploymentTime());
    assertEquals(expectedAudioTranslator.getRecoveryTime(), actualAudioTranslator.getRecoveryTime());
