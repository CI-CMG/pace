...
import static edu.colorado.cires.pace.translator.converter.ConversionUtils.stringListFromMapReplace;
...
public class PackageConverter extends Converter<PackageTranslator, Package> {
  ...
  private static CPODPackage cpodPackageFromMap(CPODPackageTranslator cpodPackageTranslator, Map<String, ValueWithColumnNumber> properties, int row,
    ...
    return CPODPackage.builder()
        ...
        .dataCollectionName(stringFromMapReplace(properties, cpodPackageTranslator.getDataCollectionName()))
        ...
        .siteOrCruiseName(stringFromMapReplace(properties, cpodPackageTranslator.getSiteOrCruiseName()))
        .deploymentId(stringFromMapReplace(properties, cpodPackageTranslator.getDeploymentId()))
  ...
  private static AudioPackage audioPackageFromMap(AudioPackageTranslator audioPackageTranslator, Map<String, ValueWithColumnNumber> properties, int row, RuntimeException runtimeException)
    ...
    return AudioPackage.builder()
        ...
        .dataCollectionName(stringFromMapReplace(properties, audioPackageTranslator.getDataCollectionName()))
        ...
        .siteOrCruiseName(stringFromMapReplace(properties, audioPackageTranslator.getSiteOrCruiseName()))
        .deploymentId(stringFromMapReplace(properties, audioPackageTranslator.getDeploymentId()))
  ...
  private static DetectionsPackage detectionsPackageFromMap(DetectionsPackageTranslator detectionsPackageTranslator, Map<String, ValueWithColumnNumber> properties,
    ...
    return DetectionsPackage.builder()
        ...
        .dataCollectionName(stringFromMapReplace(properties, detectionsPackageTranslator.getDataCollectionName()))
        ...
        .siteOrCruiseName(stringFromMapReplace(properties, detectionsPackageTranslator.getSiteOrCruiseName()))
        .deploymentId(stringFromMapReplace(properties, detectionsPackageTranslator.getDeploymentId()))
  ...
  private static SoundClipsPackage soundClipsPackageFromMap(SoundClipsPackageTranslator soundClipsPackageTranslator, Map<String, ValueWithColumnNumber> properties, int row, RuntimeException runtimeException)
    ...
    return SoundClipsPackage.builder()
        ...
        .dataCollectionName(stringFromMapReplace(properties, soundClipsPackageTranslator.getDataCollectionName()))
        ...
        .siteOrCruiseName(stringFromMapReplace(properties, soundClipsPackageTranslator.getSiteOrCruiseName()))
        .deploymentId(stringFromMapReplace(properties, soundClipsPackageTranslator.getDeploymentId()))
  ...
  private static SoundLevelMetricsPackage soundLevelMetricsPackageFromMap(SoundLevelMetricsPackageTranslator soundLevelMetricsPackageTranslator, Map<String, ValueWithColumnNumber> properties,
    ...
    return SoundLevelMetricsPackage.builder()
        ...
        .dataCollectionName(stringFromMapReplace(properties, soundLevelMetricsPackageTranslator.getDataCollectionName()))
        ...
        .siteOrCruiseName(stringFromMapReplace(properties, soundLevelMetricsPackageTranslator.getSiteOrCruiseName()))
        .deploymentId(stringFromMapReplace(properties, soundLevelMetricsPackageTranslator.getDeploymentId()))
  ...
  private static SoundPropagationModelsPackage soundPropagationModelsPackageFromMap(SoundPropagationModelsPackageTranslator soundPropagationModelsPackageTranslator,
    ...
    return SoundPropagationModelsPackage.builder()
        ...
        .dataCollectionName(stringFromMapReplace(properties, soundPropagationModelsPackageTranslator.getDataCollectionName()))
        ...
        .siteOrCruiseName(stringFromMapReplace(properties, soundPropagationModelsPackageTranslator.getSiteOrCruiseName()))
        .deploymentId(stringFromMapReplace(properties, soundPropagationModelsPackageTranslator.getDeploymentId()))
