...
public class PackageConverter extends Converter<PackageTranslator, Package> {
  ...
  private static CPODPackage cpodPackageFromMap(CPODPackageTranslator cpodPackageTranslator, Map<String, ValueWithColumnNumber> properties, int row,
    ...
    return CPODPackage.builder()
        ...
        .navigationPath(pathFromMap(properties, "Navigation Path", cpodPackageTranslator.getNavigationPath(), row, runtimeException))
        .sourcePath(pathFromMap(properties, "Source Path", cpodPackageTranslator.getSourcePath(), row, runtimeException))
        .site(stringFromMap(properties, cpodPackageTranslator.getSiteOrCruiseName()))
        ...
        .projectName(stringListFromMap(properties, cpodPackageTranslator.getProjects()))
        .publishDate(localDateFromMap(properties, "Public Release Date", cpodPackageTranslator.getPublicReleaseDate(), row, runtimeException))
        ...
        .platformName(stringFromMap(properties, cpodPackageTranslator.getPlatform()))
        .instrumentType(stringFromMap(properties, cpodPackageTranslator.getInstrument()))
        ...
        .frequencyRange(floatFromMap(properties, "Frequency Range", cpodPackageTranslator.getFrequencyRange(), row, runtimeException))
        .gain(floatFromMap(properties, "Gain", cpodPackageTranslator.getGain(), row, runtimeException))
        .title(stringFromMap(properties, cpodPackageTranslator.getDeploymentTitle()))
        .purpose(stringFromMap(properties, cpodPackageTranslator.getDeploymentPurpose()))
        ...
        .deploymentAlias(stringFromMap(properties, cpodPackageTranslator.getAlternateDeploymentName()))
  ...
  private static AudioPackage audioPackageFromMap(AudioPackageTranslator audioPackageTranslator, Map<String, ValueWithColumnNumber> properties, int row, RuntimeException runtimeException)
    ...
    return AudioPackage.builder()
        ...
        .navigationPath(pathFromMap(properties, "Navigation Path", audioPackageTranslator.getNavigationPath(), row, runtimeException))
        .sourcePath(pathFromMap(properties, "Source Path", audioPackageTranslator.getSourcePath(), row, runtimeException))
        .site(stringFromMap(properties, audioPackageTranslator.getSiteOrCruiseName()))
        ...
        .projectName(stringListFromMap(properties, audioPackageTranslator.getProjects()))
        .publishDate(localDateFromMap(properties, "Public Release Date", audioPackageTranslator.getPublicReleaseDate(), row, runtimeException))
        ...
        .platformName(stringFromMap(properties, audioPackageTranslator.getPlatform()))
        .instrumentType(stringFromMap(properties, audioPackageTranslator.getInstrument()))
        ...
        .frequencyRange(floatFromMap(properties, "Frequency Range", audioPackageTranslator.getFrequencyRange(), row, runtimeException))
        .gain(floatFromMap(properties, "Gain", audioPackageTranslator.getGain(), row, runtimeException))
        .title(stringFromMap(properties, audioPackageTranslator.getDeploymentTitle()))
        .purpose(stringFromMap(properties, audioPackageTranslator.getDeploymentPurpose()))
        ...
        .deploymentAlias(stringFromMap(properties, audioPackageTranslator.getAlternateDeploymentName()))
        .qualityAnalyst(stringFromMap(properties, qualityControlDetailTranslator.getQualityAnalyst()))
        .qualityAnalysisObjectives(stringFromMap(properties, qualityControlDetailTranslator.getQualityAnalysisObjectives()))
        .qualityAnalysisMethod(stringFromMap(properties, qualityControlDetailTranslator.getQualityAnalysisMethod()))
        .qualityAssessmentDescription(stringFromMap(properties, qualityControlDetailTranslator.getQualityAssessmentDescription()))
  ...
  private static DetectionsPackage detectionsPackageFromMap(DetectionsPackageTranslator detectionsPackageTranslator, Map<String, ValueWithColumnNumber> properties,
    ...
    return DetectionsPackage.builder()
        ...
        .navigationPath(pathFromMap(properties, "Navigation Path", detectionsPackageTranslator.getNavigationPath(), row, runtimeException))
        .sourcePath(pathFromMap(properties, "Source Path", detectionsPackageTranslator.getSourcePath(), row, runtimeException))
        .site(stringFromMap(properties, detectionsPackageTranslator.getSiteOrCruiseName()))
        ...
        .projectName(stringListFromMap(properties, detectionsPackageTranslator.getProjects()))
        .publishDate(localDateFromMap(properties, "Public Release Date", detectionsPackageTranslator.getPublicReleaseDate(), row, runtimeException))
        ...
        .platformName(stringFromMap(properties, detectionsPackageTranslator.getPlatform()))
        .instrumentType(stringFromMap(properties, detectionsPackageTranslator.getInstrument()))
        ...
        .title(stringFromMap(properties, detectionsPackageTranslator.getDeploymentTitle()))
        .purpose(stringFromMap(properties, detectionsPackageTranslator.getDeploymentPurpose()))
        ...
        .deploymentAlias(stringFromMap(properties, detectionsPackageTranslator.getAlternateDeploymentName()))
        .qualityAnalyst(stringFromMap(properties, qualityControlDetailTranslator.getQualityAnalyst()))
        .qualityAnalysisObjectives(stringFromMap(properties, qualityControlDetailTranslator.getQualityAnalysisObjectives()))
        .qualityAnalysisMethod(stringFromMap(properties, qualityControlDetailTranslator.getQualityAnalysisMethod()))
        .qualityAssessmentDescription(stringFromMap(properties, qualityControlDetailTranslator.getQualityAssessmentDescription()))
  ...
  private static SoundClipsPackage soundClipsPackageFromMap(SoundClipsPackageTranslator soundClipsPackageTranslator, Map<String, ValueWithColumnNumber> properties, int row, RuntimeException runtimeException)
    ...
    return SoundClipsPackage.builder()
        ...
        .navigationPath(pathFromMap(properties, "Navigation Path", soundClipsPackageTranslator.getNavigationPath(), row, runtimeException))
        .sourcePath(pathFromMap(properties, "Source Path", soundClipsPackageTranslator.getSourcePath(), row, runtimeException))
        .site(stringFromMap(properties, soundClipsPackageTranslator.getSiteOrCruiseName()))
        ...
        .projectName(stringListFromMap(properties, soundClipsPackageTranslator.getProjects()))
        .publishDate(localDateFromMap(properties, "Public Release Date", soundClipsPackageTranslator.getPublicReleaseDate(), row, runtimeException))
        ...
        .platformName(stringFromMap(properties, soundClipsPackageTranslator.getPlatform()))
        .instrumentType(stringFromMap(properties, soundClipsPackageTranslator.getInstrument()))
        ...
        .title(stringFromMap(properties, soundClipsPackageTranslator.getDeploymentTitle()))
        .purpose(stringFromMap(properties, soundClipsPackageTranslator.getDeploymentPurpose()))
        ...
        .deploymentAlias(stringFromMap(properties, soundClipsPackageTranslator.getAlternateDeploymentName()))
  ...
  private static SoundLevelMetricsPackage soundLevelMetricsPackageFromMap(SoundLevelMetricsPackageTranslator soundLevelMetricsPackageTranslator, Map<String, ValueWithColumnNumber> properties,
    ...
    return SoundLevelMetricsPackage.builder()
        ...
        .navigationPath(pathFromMap(properties, "Navigation Path", soundLevelMetricsPackageTranslator.getNavigationPath(), row, runtimeException))
        .sourcePath(pathFromMap(properties, "Source Path", soundLevelMetricsPackageTranslator.getSourcePath(), row, runtimeException))
        .site(stringFromMap(properties, soundLevelMetricsPackageTranslator.getSiteOrCruiseName()))
        ...
        .projectName(stringListFromMap(properties, soundLevelMetricsPackageTranslator.getProjects()))
        .publishDate(localDateFromMap(properties, "Public Release Date", soundLevelMetricsPackageTranslator.getPublicReleaseDate(), row, runtimeException))
        ...
        .platformName(stringFromMap(properties, soundLevelMetricsPackageTranslator.getPlatform()))
        .instrumentType(stringFromMap(properties, soundLevelMetricsPackageTranslator.getInstrument()))
        ...
        .title(stringFromMap(properties, soundLevelMetricsPackageTranslator.getDeploymentTitle()))
        .purpose(stringFromMap(properties, soundLevelMetricsPackageTranslator.getDeploymentPurpose()))
        ...
        .deploymentAlias(stringFromMap(properties, soundLevelMetricsPackageTranslator.getAlternateDeploymentName()))
  ...
  private static SoundPropagationModelsPackage soundPropagationModelsPackageFromMap(SoundPropagationModelsPackageTranslator soundPropagationModelsPackageTranslator,
    ...
    return SoundPropagationModelsPackage.builder()
        ...
        .navigationPath(pathFromMap(properties, "Navigation Path", soundPropagationModelsPackageTranslator.getNavigationPath(), row, runtimeException))
        .sourcePath(pathFromMap(properties, "Source Path", soundPropagationModelsPackageTranslator.getSourcePath(), row, runtimeException))
        .site(stringFromMap(properties, soundPropagationModelsPackageTranslator.getSiteOrCruiseName()))
        ...
        .projectName(stringListFromMap(properties, soundPropagationModelsPackageTranslator.getProjects()))
        .publishDate(localDateFromMap(properties, "Public Release Date", soundPropagationModelsPackageTranslator.getPublicReleaseDate(), row, runtimeException))
        ...
        .platformName(stringFromMap(properties, soundPropagationModelsPackageTranslator.getPlatform()))
        .instrumentType(stringFromMap(properties, soundPropagationModelsPackageTranslator.getInstrument()))
        ...
        .title(stringFromMap(properties, soundPropagationModelsPackageTranslator.getDeploymentTitle()))
        .purpose(stringFromMap(properties, soundPropagationModelsPackageTranslator.getDeploymentPurpose()))
        ...
        .deploymentAlias(stringFromMap(properties, soundPropagationModelsPackageTranslator.getAlternateDeploymentName()))
