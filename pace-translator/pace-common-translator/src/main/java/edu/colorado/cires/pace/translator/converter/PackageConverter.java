...
public class PackageConverter extends Converter<PackageTranslator, Package> {
  ...
  private static CPODPackage cpodPackageFromMap(CPODPackageTranslator cpodPackageTranslator, Map<String, ValueWithColumnNumber> properties, int row,
    ...
    return CPODPackage.builder()
        ...
        .startTime(localDateTimeFromMap(properties, cpodPackageTranslator.getStartTimeTranslator(), row, runtimeException))
        .endTime(localDateTimeFromMap(properties, cpodPackageTranslator.getEndTimeTranslator(), row, runtimeException))
        ...
        .deploymentTime(localDateTimeFromMap(properties, cpodPackageTranslator.getDeploymentTimeTranslator(), row, runtimeException))
        .recoveryTime(localDateTimeFromMap(properties, cpodPackageTranslator.getRecoveryTimeTranslator(), row, runtimeException))
  ...
  private static AudioPackage audioPackageFromMap(AudioPackageTranslator audioPackageTranslator, Map<String, ValueWithColumnNumber> properties, int row, RuntimeException runtimeException, PersonRepository personRepository, ProjectRepository projectRepository, OrganizationRepository organizationRepository, PlatformRepository platformRepository, InstrumentRepository instrumentRepository, SeaRepository seaRepository, ShipRepository shipRepository, SensorRepository sensorRepository)
    ...
    return AudioPackage.builder()
        ...
        .startTime(localDateTimeFromMap(properties, audioPackageTranslator.getStartTimeTranslator(), row, runtimeException))
        .endTime(localDateTimeFromMap(properties, audioPackageTranslator.getEndTimeTranslator(), row, runtimeException))
        ...
        .qualityAssessmentDescription(stringFromMap(properties, qualityControlDetailTranslator.getQualityAssessmentDescription()))
        .qualityEntries(dataQualityEntriesFromMap(qualityControlDetailTranslator.getQualityEntryTranslators(), properties, row, runtimeException))
        .deploymentTime(localDateTimeFromMap(properties, audioPackageTranslator.getDeploymentTimeTranslator(), row, runtimeException))
        .recoveryTime(localDateTimeFromMap(properties, audioPackageTranslator.getRecoveryTimeTranslator(), row, runtimeException))
  ...
  private static DetectionsPackage detectionsPackageFromMap(DetectionsPackageTranslator detectionsPackageTranslator, Map<String, ValueWithColumnNumber> properties,
    ...
    return DetectionsPackage.builder()
        ...
        .startTime(localDateTimeFromMap(properties, detectionsPackageTranslator.getStartTimeTranslator(), row, runtimeException))
        .endTime(localDateTimeFromMap(properties, detectionsPackageTranslator.getEndTimeTranslator(), row, runtimeException))
  ...
  private static SoundClipsPackage soundClipsPackageFromMap(SoundClipsPackageTranslator soundClipsPackageTranslator, Map<String, ValueWithColumnNumber> properties,
    ...
    return SoundClipsPackage.builder()
        ...
        .startTime(localDateTimeFromMap(properties, soundClipsPackageTranslator.getStartTimeTranslator(), row, runtimeException))
        .endTime(localDateTimeFromMap(properties, soundClipsPackageTranslator.getEndTimeTranslator(), row, runtimeException))
  ...
  private static SoundLevelMetricsPackage soundLevelMetricsPackageFromMap(SoundLevelMetricsPackageTranslator soundLevelMetricsPackageTranslator, Map<String, ValueWithColumnNumber> properties,
    ...
    return SoundLevelMetricsPackage.builder()
        ...
        .startTime(localDateTimeFromMap(properties, soundLevelMetricsPackageTranslator.getStartTimeTranslator(), row, runtimeException))
        .endTime(localDateTimeFromMap(properties, soundLevelMetricsPackageTranslator.getEndTimeTranslator(), row, runtimeException))
  ...
  private static SoundPropagationModelsPackage soundPropagationModelsPackageFromMap(SoundPropagationModelsPackageTranslator soundPropagationModelsPackageTranslator,
    ...
    return SoundPropagationModelsPackage.builder()
        ...
        .startTime(localDateTimeFromMap(properties, soundPropagationModelsPackageTranslator.getStartTimeTranslator(), row, runtimeException))
        .endTime(localDateTimeFromMap(properties, soundPropagationModelsPackageTranslator.getEndTimeTranslator(), row, runtimeException))
  ...
  private static DataQualityEntry dataQualityEntryFromMap(DataQualityEntryTranslator dataQualityEntryTranslator, Map<String, ValueWithColumnNumber> properties, int row, RuntimeException runtimeException) {
    return DataQualityEntry.builder()
        .startTime(localDateTimeFromMap(properties, dataQualityEntryTranslator.getStartTimeTranslator(), row, runtimeException))
        .endTime(localDateTimeFromMap(properties, dataQualityEntryTranslator.getEndTimeTranslator(), row, runtimeException))
  ...
  private static Channel channelFromMap(ChannelTranslator channelTranslator, Map<String, ValueWithColumnNumber> properties, int row, RuntimeException runtimeException, SensorRepository sensorRepository)
    ...
    return Channel.builder()
        ...
        .startTime(localDateTimeFromMap(properties, channelTranslator.getStartTimeTranslator(), row, runtimeException))
        .endTime(localDateTimeFromMap(properties, channelTranslator.getEndTimeTranslator(), row, runtimeException))
        .sampleRates(sampleRatesFromMap(channelTranslator.getSampleRateTranslators(), properties, row, runtimeException))
        .dutyCycles(dutyCyclesFromMap(channelTranslator.getDutyCycleTranslators(), properties, row, runtimeException))
        .gains(gainsFromMap(channelTranslator.getGainTranslators(), properties, row, runtimeException))
        .build();
  }
  ...
  private static SampleRate sampleRateFromMap(SampleRateTranslator sampleRateTranslator, Map<String, ValueWithColumnNumber> properties, int row, RuntimeException runtimeException) {
    return SampleRate.builder()
        .startTime(localDateTimeFromMap(properties, sampleRateTranslator.getStartTimeTranslator(), row, runtimeException))
        .endTime(localDateTimeFromMap(properties, sampleRateTranslator.getEndTimeTranslator(), row, runtimeException))
  ...
  private static DutyCycle dutyCycleFromMap(DutyCycleTranslator dutyCycleTranslator, Map<String, ValueWithColumnNumber> properties, int row, RuntimeException runtimeException) {
    return DutyCycle.builder()
        .startTime(localDateTimeFromMap(properties, dutyCycleTranslator.getStartTimeTranslator(), row, runtimeException))
        .endTime(localDateTimeFromMap(properties, dutyCycleTranslator.getEndTimeTranslator(), row, runtimeException))
  ...
  private static Gain gainFromMap(GainTranslator gainTranslator, Map<String, ValueWithColumnNumber> properties, int row, RuntimeException runtimeException) {
    return Gain.builder()
        .startTime(localDateTimeFromMap(properties, gainTranslator.getStartTimeTranslator(), row, runtimeException))
        .endTime(localDateTimeFromMap(properties, gainTranslator.getEndTimeTranslator(), row, runtimeException))
