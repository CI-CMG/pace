package edu.colorado.cires.pace.data.object.sea;
...
/**
 * Sea extends ObjectWithName
 */
@Data
@EqualsAndHashCode(callSuper = true)
@SuperBuilder(toBuilder = true)
@Jacksonized
public class Sea extends ObjectWithName {
  ...
  /**
   * Returns sea object with provided visibility
   *
   * @param visible boolean which indicates whether to make the object visible
   *                or invisible
   * @return Sea with provided visibility
   */
  @Override
