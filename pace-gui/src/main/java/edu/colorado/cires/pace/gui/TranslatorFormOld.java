...
public abstract class TranslatorFormOld<F extends TabularTranslationField, T extends TabularTranslator<F>> extends Form<T> {
  ...
  public TranslatorFormOld(T initialTranslator, Function<Supplier<List<String>>, T> translatorGenerator) {
