...
## Releases
- Latest Release: [1.0.1](https://github.com/CI-CMG/pace/releases/tag/v1.0.1)
...
2. Look under the most recent release version which is not trunk-latest (currently v1.0.1)
...
### Installation
#### MacOS
1. Download file using ``curl``: ``curl -L -O https://github.com/CI-CMG/pace/releases/download/trunk-latest/pace-cli-macOS-ARM64-1.0.1-SNAPSHOT.pkg``
2. Use ``installer`` to install ``pace-cli`` (requires sudo): ``installer -pkg pace-cli-macOS-ARM64-1.0.1-SNAPSHOT.pkg -target /``
...
#### Linux
1. Download file using ``curl``: ``curl -L -O https://github.com/CI-CMG/pace/releases/download/trunk-latest/pace-cli-Linux-X64-1.0.1-SNAPSHOT.zip``
2. Unzip file: ``unzip pace-cli-Linux-X64-1.0.1-SNAPSHOT.zip``
...
#### Windows
1. Download file using `curl`: `curl -L -O https://github.com/CI-CMG/pace/releases/download/trunk-latest/pace-cli-Windows-X64-1.0.1-SNAPSHOT.msi`
2. Execute downloaded file and follow installer prompts: `msiexec \i  pace-cli-Windows-X64-1.0.1-SNAPSHOT.msi`
