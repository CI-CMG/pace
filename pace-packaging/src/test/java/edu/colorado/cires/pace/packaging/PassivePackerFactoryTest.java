...
class PassivePackerFactoryTest {
  ...
  private AudioPackage createAudioPackage() {
    return AudioPackage.builder()
        ...
        .publicReleaseDate(LocalDate.of(2023, 3, 24))
        .projects(List.of("project 1"))
        .alternateDeploymentName("deployment alias")
        .deploymentId("deployment name")
        .siteOrCruiseName("CI01")
        .alternateSiteName("site alias")
        .deploymentTitle("test title")
        .deploymentDescription("test abstract")
        .deploymentPurpose("test purpose")
        .channels(List.of(
